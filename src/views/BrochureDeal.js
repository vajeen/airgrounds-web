...
class BrochureDeal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      name: null,
          ...
          <div>
            <div className="page-header2 page-header2-small">
              <div
                ...
                style={{
                  backgroundImage: "url(" + require("assets/img/deal.jpg") + ")",
                }}

              ></div>
              <div className="content-center">
                <h2 className="title">Brochure Deal</h2>
                <img style={{ maxWidth: "50%", verticalAlign: "center" }} src={Logo} alt='Oh ooh!' />
                <h2 className="title">&nbsp;</h2>
              </div>
            </div>
            {!this.state.showThankyou && <Container>
              <h3 className="title" style={{ marginBottom: "3px" }}>Do not miss out</h3>
              <h5 className="title" style={{ marginBottom: "3px", marginTop: "3px" }}>Tell us about your idea</h5>
              <p style={{ fontSize: "14px", marginBottom: "20px" }}>Request a quote. Drop a line with a small description. We will contact you as quickly as possible.</p>
              <div className="wrapper">
                <form>
                  ...
                  <div class="form-group">
                    <textarea value={this.state.message || ''} onChange={this.handleChange} name="message" type="text" class="form-control" placeholder="Brief Description" />
                  </div>
                </form>
                <Row>
                  <Col style={{ marginTop: "50px", marginBottom: "50px" }} className="ml-auto mr-auto text-center">
                    {!this.state.showPaypal &&
                      <button class="learn-more" onClick={this.onPressButton}>
                        ...
                        <span class="button-text-black">Send</span>
                      </button>}
                  </Col>
                </Row>
              </div>
